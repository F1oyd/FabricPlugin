...
module.exports = {
    ...
    addShellScriptBuildPhase: function (context, xcodeProjectPath) {
        ...
        var script = '"' + '${SRCROOT}' + "/\\\"" + utilities.getAppName(context) + "\\\"/Plugins/floydspace-cordova-plugin-fabric/Fabric.framework/run " + pluginConfig.apiKey + " " + pluginConfig.apiSecret + '"';
